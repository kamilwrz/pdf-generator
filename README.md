...
- `frontend/src/utils/profilePhotoVisibility.js`, lines 72–279, functions `hideProfilePhoto`, `showProfilePhoto`, `removeProfilePhoto`, `profilePhotoControlAnchor` — reversible visibility, Portico reflow, complete Slate/Tessera cluster hiding and contact/sidebar transfer, plus legacy document fallbacks
...
- Tests: `frontend/src/utils/profilePhotoVisibility.test.js`, lines 1–171; `frontend/src/templates/slate.test.js`, lines 6–72; `frontend/src/templates/tessera.test.js`, lines 6–75; `backend/tests/test_cv_template_layouts.py`, lines 103–207 and 250–362; `backend/tests/test_contact_channel_roundtrip.py`, lines 54–73; `backend/tests/test_pdf_watermark.py`, lines 119–137
...
- `frontend/src/utils/profilePhotoVisibility.js`, linie 72–279, funkcje `hideProfilePhoto`, `showProfilePhoto`, `removeProfilePhoto`, `profilePhotoControlAnchor` — odwracalna widoczność, reflow Portico, ukrycie kompletnego klastra i transfer kontaktów/sidebara Slate/Tessera oraz fallbacki starszych dokumentów
...
- Testy: `frontend/src/utils/profilePhotoVisibility.test.js`, linie 1–171; `frontend/src/templates/slate.test.js`, linie 6–72; `frontend/src/templates/tessera.test.js`, linie 6–75; `backend/tests/test_cv_template_layouts.py`, linie 103–207 i 250–362; `backend/tests/test_contact_channel_roundtrip.py`, linie 54–73; `backend/tests/test_pdf_watermark.py`, linie 119–137
