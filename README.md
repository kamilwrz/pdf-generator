...
- `frontend/src/utils/atsScore.js` — weighted ATS overall from categories (`overallPercentFromCategories`)
...
- `frontend/src/utils/atsScore.js` — ważony overall ATS z kategorii (`overallPercentFromCategories`)
