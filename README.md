...
- `backend/app/services/layout_gpt.py`, lines 79–322 (`_build_layout_snapshot_data`, `build_layout_snapshot`, `build_layout_user_prompt`), 360–428 (`_resolve_model_references`), 522–597 (`_parse_section_inventory`, `_affected_text_ids`), and 757–969 (`compile_layout_gpt_response`)
...
Tests: `backend/tests/test_layout_gpt.py`, especially `test_snapshot_inventory_includes_experience_and_education_textareas`, `test_compile_rejects_incomplete_block_move`, `test_compile_rejects_incomplete_text_inventory`, and `test_compile_rejects_unknown_compact_reference`; plus `test_openai_pricing.py`, `test_ai_credits.py`, `test_ai_chat_command.py`, `test_layout_analysis.py`, …
...
- `backend/app/services/layout_gpt.py`, linie 79–322 (`_build_layout_snapshot_data`, `build_layout_snapshot`, `build_layout_user_prompt`), 360–428 (`_resolve_model_references`), 522–597 (`_parse_section_inventory`, `_affected_text_ids`) i 757–969 (`compile_layout_gpt_response`)
- `backend/app/services/layout_analysis.py` — `resolve_directed_operation`, `summarize_geometry_issues`
- `backend/app/services/openai_pricing.py` — `usage_from_response`, `estimate_cost_usd`

Testy: `backend/tests/test_layout_gpt.py`, szczególnie `test_snapshot_inventory_includes_experience_and_education_textareas`, `test_compile_rejects_incomplete_block_move`, `test_compile_rejects_incomplete_text_inventory` i `test_compile_rejects_unknown_compact_reference`; ponadto `test_openai_pricing.py`, `test_ai_credits.py`, `test_ai_chat_command.py`, `test_layout_analysis.py`, …
