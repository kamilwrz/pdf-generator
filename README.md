...
- `frontend/src/components/editor/SectionsPanel/SectionsPanel.jsx`, lines 161–186 and 259–327, component `SectionsPanel` / function `handleAppearanceTextSize`; lines 394–503, Appearance tabs and controls — strict Sterling/Monument gate, template-specific palettes, and S–XL layout transaction; `SectionsPanel.module.css`, lines 45–82 — Sterling/Monument miniature sheets and segmented type scale; tests: `SectionsPanel.test.js`, lines 9–39
...
- `frontend/src/components/editor/SectionsPanel/SectionsPanel.jsx`, linie 161–186 i 259–327, komponent `SectionsPanel` / funkcja `handleAppearanceTextSize`; linie 394–503, zakładka i kontrolki Wyglądu — ścisła bramka Sterling/Monument, palety właściwe dla szablonu i transakcja S–XL; `SectionsPanel.module.css`, linie 45–82 — miniatury Sterling/Monument i segmentowana skala; testy: `SectionsPanel.test.js`, linie 9–39
