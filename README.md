...
- `frontend/src/components/editor/SectionsPanel/SectionsPanel.jsx`, lines 197–292, component `SectionsPanel` appearance definition; lines 367–439, functions `handleAppearancePalette` / `handleAppearanceTextSize`; lines 513–674, Appearance tab and controls — strict Sterling/Linden/Monument/Slate/Meridian/Cadenza/Vellum gate, template-specific accessible radio groups, and S–XL layout transaction; `SectionsPanel.module.css`, lines 105–144 — white-paper Meridian, Cadenza, and Vellum miniatures; tests: `SectionsPanel.test.js`, lines 9–86
...
| `pdf_elements` | Elementy kanwy (+ `extra_properties`, m.in. `fixedToPage`, `repeatOnContinuation`, `locked`, `flowRole`, `flowGroup`, `preserveInitialLayout`, `appearanceSettings` Sterling/Linden/Monument/Slate/Meridian/Cadenza/Vellum i odwracalne bazowe metryki tekstu, `runs` — nakładka dekoracji inline) |
...
- `frontend/src/components/editor/SectionsPanel/SectionsPanel.jsx`, linie 197–292, definicja wyglądu w komponencie `SectionsPanel`; linie 367–439, funkcje `handleAppearancePalette` / `handleAppearanceTextSize`; linie 513–674, zakładka i kontrolki Wyglądu — ścisła bramka Sterling/Linden/Monument/Slate/Meridian/Cadenza/Vellum, dostępne radiogrupy właściwe dla szablonu i transakcja S–XL; `SectionsPanel.module.css`, linie 105–144 — białe miniatury Meridian, Cadenzy i Vellum; testy: `SectionsPanel.test.js`, linie 9–86
...
- `scripts/generate_iconic_icons.py`, linie 61–76, `_save_png`, oraz linie 291–365, zestawy glifów palet / `SUBSET_THEMES`; `backend/template_assets/iconic/{sterling-*,linden-*,monument-*,slate-*-accent,meridian-*,cadenza-*,vellum-*}` — prawdziwe dopasowane motywy ikon dla każdego szablonu z Wyglądem; testy kolorów: `backend/tests/test_{sterling,linden,monument,slate,meridian,cadenza,vellum}_appearance_assets.py`
