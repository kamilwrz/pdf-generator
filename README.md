...
- `backend/app/services/pdf_generator.py`, lines 151–299 and 1385–1503, methods `renderImage`, `_clip_image_box`, `_draw_image_cover`, and `render_elements` — matching cover crop and exact ellipse/rounded clipping for canvas image radii
...
- `backend/app/services/pdf_generator.py`, lines 151–299, methods `PDF_Generator.renderImage`, `_clip_image_box`, and `_draw_image_cover` — shared cover crop plus rectangular, rounded, or exact circular clipping
...
- `backend/app/services/pdf_generator.py`, lines 151–299 and 1385–1503, methods `renderImage`, `_clip_image_box`, `_draw_image_cover`, and `render_elements`; cover crop, rounded/circular clipping, and hidden-slot filtering
...
- `backend/app/services/pdf_generator.py`, linie 151–299 i 1385–1503, metody `renderImage`, `_clip_image_box`, `_draw_image_cover` i `render_elements` — zgodny crop `cover` oraz dokładny clipping elipsy/zaokrągleń dla promienia obrazu z canvasu
...
- `backend/app/services/pdf_generator.py`, linie 151–299, metody `PDF_Generator.renderImage`, `_clip_image_box` i `_draw_image_cover` — ten sam offset `+1.0` co kanwa, wspólny crop `cover` oraz clipping prostokątny, zaokrąglony lub dokładnie okrągły
...
- `backend/app/services/pdf_generator.py`, linie 151–299 i 1385–1503, metody `renderImage`, `_clip_image_box`, `_draw_image_cover` i `render_elements`; crop `cover`, clipping zaokrąglony/okrągły i filtrowanie ukrytego slotu
