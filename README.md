...
- `frontend/src/pages/Hero/Hero.test.js`, linie 1–67, suite `landing product positioning` — chroni pozycjonowanie rezultatu, rozszerzoną i wyśrodkowaną oś treści/CTA hero, usunięcie animowanego showcase'u i odłożonego tekstu, komunikaty Free/AI, uczciwe zastrzeżenia funkcji, dynamiczną liczbę szablonów, anchory, buildery skierowanych startów i wszystkie istniejące zdarzenia analityczne CTA
