...
- `frontend/src/components/editor/SectionsPanel/SectionsPanel.jsx` — "+ Dodaj sekcję" entry point and modal wiring (`addModalOpen` state; `handleConfirmAddSection`); user-facing labels in `SPACING_FIELDS` / `displaySectionTitle`
...
- `frontend/src/components/editor/SectionsPanel/SectionsPanel.jsx` — przycisk „+ Dodaj sekcję” i podpięcie modala (stan `addModalOpen`; `handleConfirmAddSection`); etykiety UI w `SPACING_FIELDS` / `displaySectionTitle`
