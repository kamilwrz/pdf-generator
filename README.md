...
- `frontend/src/components/ai/AiAssistant/AiAssistant.jsx`, lines 80–156, `CorrectionCard` — stable Przed/Po correction review expansion
- `frontend/src/components/ai/AiAssistant/AiAssistant.jsx`, lines 532–1154, component `AiAssistant` — Premium upgrade path for Układ, local greeting, deferred request, layout-session history boundary, review cards, and composer
- `frontend/src/components/ai/AiAssistant/AiAssistant.jsx`, lines 571–579 and 1127–1148 — auto-growing two-line chat composer
...
- `frontend/src/components/ai/AiAssistant/AiAssistant.jsx`, linie 80–156, `CorrectionCard` — stabilne rozwijanie poprawek Przed/Po
- `frontend/src/components/ai/AiAssistant/AiAssistant.jsx`, linie 532–1154, komponent `AiAssistant` — ścieżka ulepszenia do Premium dla Układu, lokalne powitanie, odroczony request, granica historii sesji, karty zmian i pole wpisywania
- `frontend/src/components/ai/AiAssistant/AiAssistant.jsx`, linie 571–579 i 1127–1148 — automatycznie rosnące, dwuwierszowe pole czatu
