...
- `frontend/src/utils/profilePhotoVisibility.js`, lines 72–312, functions `hideProfilePhoto`, `showProfilePhoto`, `removeProfilePhoto`, `profilePhotoControlAnchor`, `alignSidebarAfterProfileContacts` — reversible visibility, Portico reflow, complete Slate/Tessera cluster hiding, actual contact-stack measurement and contact/sidebar transfer, plus legacy document fallbacks
...
- Tests: `frontend/src/utils/profilePhotoVisibility.test.js`, lines 1–220; `frontend/src/templates/slate.test.js`, lines 6–78; `frontend/src/templates/tessera.test.js`, lines 6–81; `backend/tests/test_cv_template_layouts.py`, lines 103–215 and 258–378; `backend/tests/test_contact_channel_roundtrip.py`, lines 54–73; `backend/tests/test_pdf_watermark.py`, lines 119–137
...
- `frontend/src/utils/profilePhotoVisibility.js`, linie 72–312, funkcje `hideProfilePhoto`, `showProfilePhoto`, `removeProfilePhoto`, `profilePhotoControlAnchor`, `alignSidebarAfterProfileContacts` — odwracalna widoczność, reflow Portico, ukrycie kompletnego klastra, pomiar rzeczywistego stosu kontaktów i transfer kontaktów/sidebara Slate/Tessera oraz fallbacki starszych dokumentów
...
- Testy: `frontend/src/utils/profilePhotoVisibility.test.js`, linie 1–220; `frontend/src/templates/slate.test.js`, linie 6–78; `frontend/src/templates/tessera.test.js`, linie 6–81; `backend/tests/test_cv_template_layouts.py`, linie 103–215 i 258–378; `backend/tests/test_contact_channel_roundtrip.py`, linie 54–73; `backend/tests/test_pdf_watermark.py`, linie 119–137
