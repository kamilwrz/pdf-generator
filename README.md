...
- `frontend/src/components/ai/AiAssistant/AiAssistant.jsx`, lines 525–1132, component `AiAssistant` — layout-session history boundary, request flow, review cards, and composer
...
- `frontend/src/components/ai/AiAssistant/AiAssistant.jsx`, linie 525–1132, komponent `AiAssistant` — granica historii sesji Układu, wysyłanie żądań, karty zmian i pole wpisywania
