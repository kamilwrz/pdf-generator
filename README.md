...
- `frontend/src/utils/sterlingAppearance.test.js`, lines 27–41 — legacy Sterling ticks and the Linden footer normalize to one point while Cadenza and arbitrary lines remain unchanged
...
- `frontend/src/utils/sterlingAppearance.test.js`, linie 27–41 — stare kreski Sterlinga i stopka Linden normalizują się do jednego punktu, a Cadenza i dowolne linie pozostają niezmienione
