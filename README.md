...
Tessera also supports manual [main ↔ sidebar section transfer](#transfer-section-between-main-and-sidebar) from the heading toolbar's overflow menu — a movable section restyles for its destination column (Tessera's mosaic tile chrome vs its main-column type) and re-packs both lanes.
...
Tessera obsługuje też ręczne [przenoszenie sekcji między main a sidebarem](#przenoszenie-sekcji-między-kolumną-główną-a-sidebarem) z menu nadmiarowego paska nagłówka — przenoszalna sekcja jest restylowana pod docelową kolumnę (mozaikowe kafle Tessery vs typografia kolumny głównej) i oba tory są przepakowywane.
