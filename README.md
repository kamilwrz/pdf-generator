...
- `backend/app/services/ai_assistant_service.py`, lines 1044–1139, `_layout_session` — UI-ready plain-language summary and tips; plus `_model_for_action`, `_chat`, `_rate_design`
...
- `backend/app/services/ai_assistant_service.py`, linie 1044–1139 — `_layout_session`, gotowe dla UI proste podsumowanie i wskazówki; ponadto `_model_for_action`
