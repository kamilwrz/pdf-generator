...
- `backend/app/services/layout_gpt.py`, lines 43–475 (`_can_share_text_row`, `_build_text_rows`, `_build_layout_snapshot_data`, `build_layout_snapshot`, `build_layout_user_prompt`), 513–581 (`_resolve_model_references`), 675–750 (`_parse_section_inventory`, `_affected_text_ids`), and 910–1135 (`compile_layout_gpt_response`)
...
Tests: `backend/tests/test_layout_gpt.py`, especially `test_snapshot_groups_side_by_side_text_nodes_into_one_row`, `test_snapshot_normalizes_near_zero_height_text_nodes`, `test_snapshot_keeps_unrelated_columns_in_separate_rows`, `test_snapshot_inventory_includes_experience_and_education_textareas`, `test_compile_rejects_incomplete_block_move`, `test_compile_rejects_incomplete_text_inventory`, `test_compile_rejects_unknown_compact_reference`, and `test_compile_tolerates_known_decoration_in_text_inventory_members`; plus `test_openai_pricing.py`, `test_ai_credits.py`, `test_ai_chat_command.py`, `test_layout_analysis.py`, …
...
- `backend/app/services/layout_gpt.py`, linie 43–475 (`_can_share_text_row`, `_build_text_rows`, `_build_layout_snapshot_data`, `build_layout_snapshot`, `build_layout_user_prompt`), 513–581 (`_resolve_model_references`), 675–750 (`_parse_section_inventory`, `_affected_text_ids`) i 910–1135 (`compile_layout_gpt_response`)
- `backend/app/services/layout_analysis.py` — `resolve_directed_operation`, `summarize_geometry_issues`
- `backend/app/services/openai_pricing.py` — `usage_from_response`, `estimate_cost_usd`

Testy: `backend/tests/test_layout_gpt.py`, szczególnie `test_snapshot_groups_side_by_side_text_nodes_into_one_row`, `test_snapshot_normalizes_near_zero_height_text_nodes`, `test_snapshot_keeps_unrelated_columns_in_separate_rows`, `test_snapshot_inventory_includes_experience_and_education_textareas`, `test_compile_rejects_incomplete_block_move`, `test_compile_rejects_incomplete_text_inventory`, `test_compile_rejects_unknown_compact_reference` i `test_compile_tolerates_known_decoration_in_text_inventory_members`; ponadto `test_openai_pricing.py`, `test_ai_credits.py`, `test_ai_chat_command.py`, `test_layout_analysis.py`, …
