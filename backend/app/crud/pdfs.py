...
def elements_from_rows(rows) -> list[PdfElement]:
    ...
    for row in rows:
        ...
        elements.append(PdfElement(
            ...
            editorSectionType=extra.get("editorSectionType"),
            ...
            profilePhotoHiddenTop=extra.get("profilePhotoHiddenTop"),
            ...
            starterPlaceholder=extra.get("starterPlaceholder", False),
            starterSectionKey=extra.get("starterSectionKey"),
            cvDataBindings=extra.get("cvDataBindings"),
        ))
    return elements
    ...
    for element in elements:
        ...
        pdf_elements_db = PdfElements(
            ...
            extra_properties={
                ...
                "nameFit": getattr(element, "nameFit", None),
                ...
                "starterPlaceholder": getattr(element, "starterPlaceholder", False),
                "starterSectionKey": getattr(element, "starterSectionKey", None),
                "cvDataBindings": getattr(element, "cvDataBindings", None),
                ...
                **_serialize_grid_section_metadata(element),
                ...
                "profilePhotoHiddenTop": getattr(element, "profilePhotoHiddenTop", None),
