    ...
    content: list[dict] = [
        {
            ...
            "text": (
                ...
                "  Gdy skills=[] bo treści są w rodzinach/podsekcjach, użyj 'UMIEJĘTNOŚCI'.\n"
                "  Nie wstawiaj nazw podsekcji (np. 'BEZPIECZEŃSTWO') ani 'ZNANE NARZĘDZIA'\n"
                ...
                "  Szkolenia z cyberbezpieczeństwa, Umiejętności miękkie/twarde, Narzędzia,\n"
                "  podsekcje skills (Bezpieczeństwo, Przemysł / OT, …) —\n"
                ...
                "             (języki, certyfikaty-listy, zainteresowania, podsekcje skills, narzędzia).\n"
