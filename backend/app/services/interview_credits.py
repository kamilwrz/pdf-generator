...
def interview_credit_usage(db, row):
    ...
    for reservation in reservations:
        ...
        help_stage = stage in {'answer-help', 'answer-help-verify'}
        operation = "next" if stage in {"next", "analysis"} else "answer-help" if help_stage else "preview" if stage in {"preview", "editorial", "verify", "editorial-repair", "verify-repair"} or fit_stage else "other"
        ...
        item["stages"].append({
            "operation": fit_stage or (stage if help_stage or stage in {"next", "analysis", "preview", "editorial", "verify", "editorial-repair", "verify-repair"} else "other"),
