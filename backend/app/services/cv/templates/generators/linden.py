...
from app.services.cv.layout.primitives import Builder, _line, _rect, _text
...
from app.services.cv.templates.shared.text import _compact_text
from app.services.cv.templates.generators.sterling import (
