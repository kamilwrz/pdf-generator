...
from app.services.cv.layout.primitives import get_spacing, Builder
...
def _education_sidebar_content(education: list[dict]) -> str:
    ...
    Slate and Sterling no longer render this mashed string — they emit
...
def _sidebar_education_section_height(
    ...
    *,
    ...
    budget matches what Slate / Sterling actually emit.
    """
    total = 0.0
