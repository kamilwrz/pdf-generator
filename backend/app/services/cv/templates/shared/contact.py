...
from app.services.cv.contact_links import contact_display_label, contact_social_items
from app.services.cv.templates.shared.icons import _icon_beside
from app.services.cv.layout.primitives import Builder, _block, _text
