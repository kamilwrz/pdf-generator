...
from app.services.cv.templates.generators.monument import _gen_monument
from app.services.cv.templates.generators.slate import _gen_slate
from app.services.cv.templates.generators.atrium import _gen_atrium
from app.services.cv.templates.generators.sterling import _gen_sterling
from app.services.cv.templates.generators.regent import _gen_regent
from app.services.cv.templates.generators.meridian import _gen_meridian
from app.services.cv.templates.generators.linden import _gen_linden
