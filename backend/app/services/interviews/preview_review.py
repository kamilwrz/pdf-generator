...
from app.services.interviews.recovery import _dependent_scope
from app.services.interviews.clarification import _context
...
def review_preview(db, user, row, request):
    ...
    from app.services.interviews.fit import initialise_fit
