"""Regression coverage for Linden's palette-specific contact and portrait assets."""
...
PALETTE_ICON_COLORS = {
    "linden-gallery": "#0E6870",
    "linden-carmine": "#A2444E",
    "linden": "#285548",
    "linden-midnight": "#C19752",
    "linden-cobalt": "#B44F38",
    "linden-plum": "#B07B68",
}
LINDEN_ICONS = (
...
def test_each_linden_palette_has_correctly_colored_icons() -> None:
    """Every selectable palette must resolve to complete, truly coloured PNGs."""
    for theme, hex_color in PALETTE_ICON_COLORS.items():
        expected_rgb = _hex_to_rgb(hex_color)
        for icon_name in LINDEN_ICONS:
            icon_path = ASSET_ROOT / theme / f"{icon_name}.png"
            assert icon_path.exists(), f"Missing Linden icon: {icon_path}"
