...
A static original female illustration is labelled **Asystent CV / CV Assistant**, without a name, voice or professional qualification claims. Use `public/cv-onboarding-guide.png` on white paper: 176px normally, 112px on phones, 96px beside template tasks and 64px on compact template screens. It is decorative to assistive technology because the adjacent label identifies its role. Use the shared neutral brown palette, rectangular controls, 44px targets and reduced-motion rules. Do not copy competitor statistics, ATS promises or privacy assurances.
