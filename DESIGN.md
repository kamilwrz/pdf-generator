...
A static original female illustration accompanies the question, without a name, voice or professional qualification claims. Use `public/cv-onboarding-guide.png` on white paper: 96px beside the heading, reduced to 64px on phones or viewports at most 800px high. Keep **Asystent CV / CV Assistant** as an accessible label and the image decorative. Use the shared neutral brown palette, rectangular controls, 44px targets and reduced-motion rules. Do not copy competitor statistics, ATS promises or privacy assurances.
