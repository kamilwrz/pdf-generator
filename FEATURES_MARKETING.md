...
**Stan oferty:** edytor A4, 28 szablonów, import PDF → fill, kreator bio, asystent AI, plany Free / Standard / Premium, eksport PDF 1:1 z płótnem.
...
### 1.8. Biblioteka 28 szablonów branżowych

**Co:** Kolekcje m.in. Finanse, IT, Classic, Sidebar, Banking, Dark + rodzina Iconic (Nova, Ridge, Loom, Volt). Mockupy A4 w galerii i przy wyborze po imporcie.
...
| **28 szablonów branżowych** | Finanse, IT, banking, classic, dark… wygląd pod rolę, nie pod „uniwersalność”. |
...
Mini-lista: asystent AI (8 akcji) · 28 szablonów · autozapis · Moje dokumenty
...
| 28 szablonów | Wygląd pod branżę i rolę. |
