...
**Stan oferty:** edytor A4, 24 szablony, import PDF → fill, kreator bio, asystent AI, plany Free / Standard / Premium, eksport PDF 1:1 z płótnem.
...
### 1.8. Biblioteka 24 szablonów branżowych
...
| **24 szablony branżowe** | Finanse, IT, banking, classic, dark… wygląd pod rolę, nie pod „uniwersalność”. |
...
Mini-lista: asystent AI (8 akcji) · 24 szablony · autozapis · Moje dokumenty
...
| 24 szablony | Wygląd pod branżę i rolę. |
