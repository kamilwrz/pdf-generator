...
test("inspector keeps its compact 272px footprint when the live dock fits", () => {
  assert.equal(EDITOR_INSPECTOR_FIXED_WIDTH_PX, 272);
  for (const exactDockWidth of [272, 320, 640]) {
