  ...
  return <SiteLayout title="Jak korzystać z CV Studio?" eyebrow="POMOC KROK PO KROKU" intro="Wybierz temat: tworzenie CV, wywiad AI, dopasowanie do oferty, import lub zapis. Możesz wrócić do każdej instrukcji w trakcie pracy."
    ...
    <section id="wywiad" tabIndex={-1} className={classes.guideStep}>
      ...
      <div className={classes.guideFaq}>
        <details><summary>Czy mogę pracować nad CV innej osoby?</summary><p>Tak. Wybierz jej dokument lub import jako źródło. Wywiad domyślnie używa tylko tego CV i odpowiedzi z tej rozmowy, bez danych Twojego profilu. Nie zaznaczaj „To moje CV — dołącz mój profil zawodowy”. Aby zacząć bez dokumentu, wybierz „Nowe CV — bez profilu konta”. Starsze rozmowy sprzed rozdzielenia źródeł zachowują odpowiedzi, ale wymagają rozpoczęcia nowego wywiadu.</p></details>
