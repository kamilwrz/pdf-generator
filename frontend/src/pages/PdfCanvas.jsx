...
export function EditorController() {
  ...
  const canvasValue = useMemo(() => ({
    ...
    isTwoPageView, toggleTwoPageView, handleAddTextarea, handleAddSection, openAddSectionModal, openFlatSectionLayoutModal, openSkillsLayoutModal, handleAddSectionRecord, handleAddGridSectionEntry, handleAddRecordBlock, handleAddRecordDescription, handleRemoveSection, handleRemoveGridSectionEntry, handleRemoveRecordBlock, handleRemoveRecordDescription, handleReorderRecordBlock, handleReorderSection, handleTransferSectionLane, handleChangeSkillsDisplayMode, markSelected, handleSetTextareaEditing, requestTextEdit, requestEditZoomRestore, editZoomSpreadTransitionRef,
