...
export const TEMPLATES = [
    ...
    { id: "aurelia", tier: "paid", name: "Aurelia", description: "Biało-szary editorial z mocnym złotym łukiem Béziera", layouts: ["single"], accent: "#B3924F", elements: aureliaTemplate },
];
