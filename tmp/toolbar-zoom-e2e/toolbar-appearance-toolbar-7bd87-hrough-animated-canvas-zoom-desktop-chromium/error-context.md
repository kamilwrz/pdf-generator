...
- Name: toolbar-appearance.spec.js >> toolbar geometry and menu text grow monotonically through animated canvas zoom
- Location: e2e\toolbar-appearance.spec.js:176:1
      ...
      - generic [ref=f1e125]:
        - generic:
          ...
          - generic:
            - paragraph: JĘZYKI
          - generic: Polski · C2
    - button "Otwórz asystenta AI" [ref=f1e134] [cursor=pointer]:
      - generic [ref=f1e137]: Asystent AI
  - generic [ref=f1e138]:
    - button "Dodaj sekcję poniżej" [ref=f1e139] [cursor=pointer]:
      - generic [ref=f1e141]: Sekcja
    - button "Przenieś wyżej" [disabled] [ref=f1e143]
    - button "Przenieś niżej" [ref=f1e146] [cursor=pointer]
    - 'button "Styl umiejętności: w linii" [ref=f1e149] [cursor=pointer]'
    - button "AI dla wybranego zakresu" [active] [ref=f1e155] [cursor=pointer]
    - button "Więcej działań" [ref=f1e159] [cursor=pointer]
```